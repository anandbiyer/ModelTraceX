"""
ModelTraceX sample Python model 13: deposit_balance_decay
...
def run_deposit_balance_decay() -> Dict[str, float]:
    ...
    summary["model_id"] = 13.0
    summary["category_hash"] = 221.0
    return summary
...
if __name__ == "__main__":
    output = run_deposit_balance_decay()
