"""
ModelTraceX sample Python model 06: pd_logistic_retail
Category: PD
...
def run_pd_logistic_retail() -> Dict[str, float]:
    ...
    summary["model_id"] = 6.0
    summary["category_hash"] = 102.0
    return summary
