"""
ModelTraceX sample Python model 15: loan_amortization_fixed_rate
...
def run_loan_amortization_fixed_rate() -> Dict[str, float]:
    ...
    summary["model_id"] = 15.0
    summary["category_hash"] = 255.0
    return summary
...
if __name__ == "__main__":
    output = run_loan_amortization_fixed_rate()
