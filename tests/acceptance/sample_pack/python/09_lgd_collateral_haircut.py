"""
ModelTraceX sample Python model 09: lgd_collateral_haircut
Category: LGD
...
def run_lgd_collateral_haircut() -> Dict[str, float]:
    ...
    summary["model_id"] = 9.0
    summary["category_hash"] = 153.0
    return summary
...
if __name__ == "__main__":
    output = run_lgd_collateral_haircut()
