"""
ModelTraceX sample Python model 107: 07_credit_conversion_factor
Category: Chained Model
Purpose: CCF/EAD model; consumes downturn_lgd.csv and produces ead_projection.csv.
...
def run_07_credit_conversion_factor() -> Dict[str, float]:
    ...
    summary["model_id"] = 107.0
    summary["category_hash"] = 1819.0
    return summary
...
if __name__ == "__main__":
    output = run_07_credit_conversion_factor()
    checks = validation_checks(output)
    print("MODEL OUTPUT", output)
    print("VALIDATION ISSUES", checks)

# CHAIN_INPUT = "downturn_lgd.csv"
# CHAIN_OUTPUT = "ead_projection.csv"
# CHAIN_ORDER = 7
