"""
ModelTraceX sample Python model 106: 06_downturn_lgd_model
Category: Chained Model
Purpose: Downturn LGD model; consumes collateral_forecast.csv and produces downturn_lgd.csv.
...
def run_06_downturn_lgd_model() -> Dict[str, float]:
    ...
    summary["model_id"] = 106.0
    summary["category_hash"] = 1802.0
    return summary
...
if __name__ == "__main__":
    output = run_06_downturn_lgd_model()
    checks = validation_checks(output)
    print("MODEL OUTPUT", output)
    print("VALIDATION ISSUES", checks)

# CHAIN_INPUT = "collateral_forecast.csv"
# CHAIN_OUTPUT = "downturn_lgd.csv"
# CHAIN_ORDER = 6
