...
| P2-8 | Review tab (§13.4.2): project-summary + model list w/ confidence/status, document pane live from RunState in Part A order, provenance callouts, per-model + project DOCX download | Not Started | |
